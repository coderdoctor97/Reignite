...
Revision ID: d0c7aa2d0f36
Revises: 
Create Date: 2026-08-30 13:34:44.161390
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_credential_events_event_type'), 'credential_events', ['event_type'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_credential_events_event_type'), table_name='credential_events')
